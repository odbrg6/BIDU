...
async def supc(event): 
    ...
    zed_dev = (6007372789, 5468844059, 2037509891, 5555953200)
    ...
    if gvarstatus ("sub_private"):
        try:
            ...
            if "error_code" in reqt:
                await zedub.tgbot.send_message(BOTLOG_CHATID, f"**- خطـأ غير معروف قم باعادة توجيه الرسالة ل @B_IDU لحل المشكلة\n{reqt}**")
