#𝐴𝐷𝑇𝐻𝑂𝑁 ®
#الملـف حقـوق وكتابـة زلـزال الهيبـه ⤶ @B_IDU خاص بسـورس ⤶ 𝐴𝐷𝑇𝐻𝑂𝑁
...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 𝐬𝐨𝐮𝐫𝐜𝐞 𝐚𝐝 𓆪 </b> - @adthon "
...
async def who(event):
    ...
    if replied_user.id == 6007372789 or replied_user.id == 5468844059 or replied_user.id == 2037509891:
