...
ZelzalVP_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝐀𝐃𝐓𝐇𝐎𝐍  𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر الفـارات](t.me/adthon) 𓆪\n\n"
    ...
    "\n𓆩 [𝙑𝙖𝙧𝙨 - قنـاة الفـارات](t.me/adthone1) 𓆪"
)
...
async def variable(event):
    ...
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        ...
        if variable in heroku_var:
            await zed.edit("** ❈╎تم تغييـر {} بنجـاح ☑️**\n** ❈╎المتغيـر : ↶**\n `{}` \n** ❈╎يتم الان اعـادة تشغيـل بـوت ادثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str, vinfo))
        else:
            await zed.edit("** ❈╎تم اضافـة {} بنجـاح ☑️** \n** ❈╎المضاف اليه :**\n `{}` \n** ❈╎يتم الان اعـادة تشغيـل بـوت ادثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str, vinfo))
...
async def variable(event):
    ...
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        ...
        await zed.edit("** ❈╎تم حـذف {} بنجـاح ☑️**\n** ❈╎المتغيـر المحـذوف : ↶**\n `{}` \n** ❈╎يتم الان اعـادة تشغيـل بـوت ادثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str, variable))
        ...
        if variable not in heroku_var:
        	return await zed.edit("** ❈╎عـذࢪاً عـزيـزي .. انت لـم تقـم باضـافـة فـار {} اصـلاً...**".format(input_str))
        await zed.edit("** ❈╎تم حـذف {} بنجـاح ☑️**\n** ❈╎المتغيـر المحـذوف : ↶**\n `{}` \n** ❈╎يتم الان اعـادة تشغيـل بـوت ادثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str, heroku_var[variable]))
    ...
    elif input_str == "نقطة " or input_str == "نقطه الاوامر":
        variable = "COMMAND_HAND_LER"
        await asyncio.sleep(1.5)
        if variable not in heroku_var:
        	return await zed.edit("** ❈╎عـذࢪاً عـزيـزي .. انت لـم تقـم باضـافـة فـار {} اصـلاً...**".format(input_str))
...
async def custom_zed(event):
    ...
    if (input_str == "كليشة الحماية" or input_str == "كليشة الحمايه" or input_str == "كليشه الحماية" or input_str == "كليشه الحمايه"):
        ...
        if variable is None:
            ...
            await zed.edit("** ❈╎الفـار {} موجـود ☑️**\n** ❈╎قيمـة الفـار : ↶**\n `{}` \n\n** ❈╎قنـاة السـورس : @adthon**".format(input_str, variable))
    ...
    if malatha.reply_to_msg_id:
        ...
        if input_str in ["الحماية", "الحمايه"]:
            ...
            try:
                ...
                await zed.edit("** ❈╎تم تغييـر صـورة {} .. بنجـاح ☑️**\n** ❈╎المتغيـر : ↶**\n `{}` \n\n** ❈╎قنـاة السـورس : @adthon**".format(input_str, vinfo))
