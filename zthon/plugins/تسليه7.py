...
async def _(event):
    zel_dev = (6007372789, 6007372789, 6007372789, 6007372789, 6007372789, 6007372789, 6007372789, 6007372789, 6007372789, 6007372789, 6007372789, 6007372789, 6007372789, 6007372789, 6007372789, 6007372789, 6007372789, 6007372789, 6007372789)
    if event.reply_to_msg_id:
        ...
        if idd == 6007372789 or idd == 5468844059 or idd == 5280339206 or idd == 1346542270:
            ...
            animation_chars = [
                "**⌔: جاري الاتصال بخوادم ادثون المتخصصه بالـتهكير**",
