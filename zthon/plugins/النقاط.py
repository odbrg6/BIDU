...
ZelzalCoins_cmd = (
    "[ᯓ 𝘀𝗼𝘂𝗿𝗰𝗲 𝐀𝐃𝐓𝐇𝐎𝐍  - اوامـر تجميـع النقـاط](t.me/adthon) 𓆪\n\n"
    "**⎉╎قـائمـة اوامـر تجميـع نقـاط بوتـات تمـويـل الخاص بسـورس ادثون🦾 :** \n\n"
    "`.المليار`\n"
    "**⪼ لـ تجميـع النقـاط مـن بـوت المليـار ( @KBKBOT ) .. تلقائيًا ✓**\n\n"
    "`.الجوكر`\n"
    ...
    "`.راتب وعد 50`\n\n\n"
    "**- مـلاحظــه :**\n"
    "**⪼ سيتم اضـافـه المزيـد من البوتـات بالتحديثـات الجايـه .. إذا تريـد اضافـة بـوت محـدد راسـل مطـور السـورس @B_IDU**"
)
