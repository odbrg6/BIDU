...
async def _ban_person(event):
    ...
    if user.id == 6007372789 or user.id == 6007372789 or user.id == 6007372789:
...
async def startmute(event):
    ...
    if event.is_private:
        ...
        if event.chat_id == 6007372789 or event.chat_id == 5468844059 or event.chat_id == 2037509891:
        ...
        if user.id == 6007372789 or user.id == 5468844059 or user.id == 2037509891:
