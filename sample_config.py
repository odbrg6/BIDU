...
class Config(object):
    ...
    # Get this value by running python3 stringsetup.py or https://repl.it/@adthonn/stringsession
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/odbrg6/PPF22"
    )
    ...
    OLDZED_REPO = os.environ.get("OLDZED_REPO", "https://github.com/odbrg6/v2")
    if OLDZED_REPO and not url(OLDZED_REPO):
        OLDZED_REPO = "https://github.com/odbrg6/v2"
